...
(function ($){
	...
	var QuizDraggable = QuizDraggable || (function ()
	{
		...
		function onTouchStart( e )
		{
			...
			if(!target.data("area"))
			{
				...
				this.touchTarget.css({"z-index":zDepth});
		...
		function onTouchEnd( e )
		{
			...
			if(this.touchTarget)
			{
				if(this.options.addZDepth == true) zDepth++;
				...
				if(this.options.onlyDrag == true)
				{
					...
					if(this.options.addZDepth != true) this.touchTarget.css({"z-index":""});
	...
	// 메인 기본 옵션
	/**
	 * addZDepth : 드래그 end해도 zIndex를 최상위로 유지하는 옵션 (mm_32_2_11_01_03, mm_31_1_08_01_03)
