...
require(['jquery', 'class', 'dvd_4_2_p/resource/contents/lesson05/ops/common/js/common', 'quizMain', 'quizCheck', 'quizCheckMulti', 'quizDraggable', 'quizInput', 'quizPopSelect', 'quizDrawLine'], function ($) {
...
require(['jquery', 'class', 'tweenmax', 'dvd_4_2_p/resource/contents/lesson05/ops/common/js/common', 'cornerBase', 'mindMap'], function ($) {
...
require(['jquery', 'class', 'overlayscrollbars', 'tweenmax', 'dvd_4_2_p/resource/contents/lesson05/ops/common/js/common', 'cornerBase', 'videoplayer'], function ($) {
	load();
	init();
});
