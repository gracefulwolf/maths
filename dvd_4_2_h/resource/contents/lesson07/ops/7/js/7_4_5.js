  ...
  window.addEventListener('load', function() {
    ...
    function dragCallback(dragDrop) {
      ...
      if(dropArea.element.classList.contains('dropArea_1')) {
        if (dropArea.element.children.length === 5) dropArea.DISABLED = true;
      }else if(dropArea.element.classList.contains('dropArea_2')) {
        if (dropArea.element.children.length === 3) dropArea.DISABLED = true;
      }else{
        if (dropArea.element.children.length === 4) dropArea.DISABLED = true;
      }
