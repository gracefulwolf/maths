...
function dropCompareA(dragObj, x, y) {
    ...
    for (var i=0; i<dragDropManagerA.dropAreas.length; i++) {
        var dropValue = dragDropManagerA.dropAreas[i].getAttribute("drag-ans"),
			dropValue2 = dragDropManagerA.dropAreas[i].getAttribute("drag-ans2"),
			dropValue3 = dragDropManagerA.dropAreas[i].getAttribute("drag-ans3"),
        ...
        if (x > left &&
            ...
            if ((dragObjValue == dropValue || dragObjValue == dropValue2 || dragObjValue == dropValue3) && !dragDropManagerA.dropAreas[i].classList.contains("dropX")) {
