function initScene() {
  ...
  figureImg.style.background = "url(../include/images/common/shape/" + gameManager.QUIZ_OPTION[0] + ".png) no-repeat";
  ...
  for (var i = 1; i < 3; i++) {
    ...
    if (gameManager.QUIZ_OPTION[i][0] == "text") {
      ...
      // questionTextWrap.style.background = 'url(../include/images/common/' + gameManager.QUIZ_OPTION[i][1] + '/' + gameManager.QUIZ_OPTION[i][2] + '_' + gameManager.QUIZ_OPTION[i][3] + '.png) no-repeat';

      // }else if(gameManager.QUIZ_OPTION[i][0].length == 6){
      // 	questionTextWrap.style.background = 'url(../include/images/common/' + gameManager.QUIZ_OPTION[i][1] + '/' + gameManager.QUIZ_OPTION[i][2] + '_' + gameManager.QUIZ_OPTION[i][3] + '_' + gameManager.QUIZ_OPTION[i][4] +'.png) no-repeat';
      // }

      // questionTextWrap.style.background = 'url(../include/images/common/' + gameManager.QUIZ_OPTION[i][1] + '/' + gameManager.QUIZ_OPTION[i][2] + '.png) no-repeat';
      ...
      questionImg.style.background = "url(../include/images/common/" + gameManager.QUIZ_OPTION[i][1] + "/" + gameManager.QUIZ_OPTION[i][2] + ".png) center center no-repeat";
