...
DragdropHorizontal.prototype.createDragdrop = function () {
  var dragDrop = this,
    ...
    drag = function (e) {
      ...
      dragDrop.element.removeEventListener('mouseup', shootingDrop.shootRun);
      // dragDrop.element.removeEventListener('touchend', shootingDrop.shootRun);
    ...
    endDrag = function (e) {
      ...
      dragDrop.element.addEventListener('mouseup', shootingDrop.shootRun);
      // dragDrop.element.addEventListener('touchend', shootingDrop.shootRun);
      this.style.zIndex = 2;
    },
    outDrag = function (e) {
      var eventMaster = eventSelector("upEvent", e);
      ...
      if (eventMaster !== undefined) boundingOutCircle(this, eventMaster.clientX, eventMaster.clientY);
    };
  ...
  dragDrop.element.addEventListener('mouseout', outDrag, false);
  // dragDrop.element.addEventListener('touchleave', outDrag, false);
};
...
function boundingOutCircle(dragObj, x, y) {
  ...
  dragObj.style.left = bubble.getElement().offsetLeft + 50 + "px";
}
...
var Bubble = function () {
  ...
  this.reset = function () {
    ...
    if (_element) {
      ...
      try {
        _element.classList.remove(_clearClassName);
      } catch (e) {}
    }
  };
  ...
  this.clear = function () {
    ...
    if (_element) {
      try {
        _element.classList.add(_clearClassName);
      } catch (e) {}
      try {
        _element.classList.remove(_noClearClassName);
      } catch (e) {}
...
var Shooter = function () {
  ...
  this.setCurrent = function (index) {
    ...
    var tx = bubble.getElement().offsetLeft + 50;
