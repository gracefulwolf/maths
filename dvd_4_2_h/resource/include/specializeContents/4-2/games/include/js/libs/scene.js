...
function appendChoiceQuestion(buttonType, choiceQuestionArray, imgSrcArray) {
  ...
  switch (gameManager.choiceQuestion.length) {
    ...
    case 2:
      choiceLeft = 150;
      if (gameManager.CURRENT_TYPE === "picture") choiceLeft = 960;
...
function compareAnswer(dragObj) {
  ...
  var dragAnswerValue = 
   typeof gameManager.CURRENT_ANSWER[0] !== "number" ? dragObj.getAttribute("answerValue") 
    : parseInt(dragObj.getAttribute("answerValue"));

  if (gameManager.CURRENT_ANSWER[0] === dragAnswerValue) {
