...
window.MATH.archive['math_4-2'] = {
  ...
  datas: {
    // common: [
    //   [
    //     { disabled: false, fileUrl: '../../data/공통 자료/4-2 전단원 PDF 자료-수학 익힘.pdf', disabledLessons: [7] },
    //     { disabled: false, fileUrl: '../../data/공통 자료/4-2 전단원 PDF 자료-수학.pdf' },
    //     { disabled: false, fileUrl: '../../data/공통 자료/4-2 전단원 PDF 자료-지도서 총론.pdf', disabledLessons: [7] },
    //     { disabled: false, fileUrl: '../../data/공통 자료/4-2 전단원 PDF 자료-지도서.pdf' },
    //   ],
    ...
    lessons: [
      ...
      [
        ...
        [
          ...
          [
            { fileUrl: '../../data/01/1단원 준비물_교구 목록.hwp', disabled: true },
        ...
        [
          [
            ...
            { disabled: false, fileUrl: '../../data/공통 자료/4-2 전단원 PDF 자료-지도서 총론.pdf' },
          ],
      ...
      [
        ...
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/02/PDF 자료-수학/2단원_8, 9차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/02/PDF 자료-지도서/2단원_8, 9차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/02/PDF 자료-수학 익힘/2단원_8, 9차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '', disabled: true },
        ],
        // 9차시
      ...
      [
        ...
        [
          ...
          [
            { fileUrl: '../../data/03/3단원 준비물_교구 목록.hwp', disabled: true },
        ...
        // 8차시
        [
          { fileUrl: '../../data/03/3단원_8차시 수업용 PPT.pptx', disabled: false },
          [
            ...
            { fileUrl: '../../data/03/PDF 자료-수학 익힘/3단원_8차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/03/3단원_8차시 형성평가.hwp', disabled: false },
        ],
        // 9차시
        [
          { fileUrl: '../../data/03/3단원_9차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/03/PDF 자료-수학/3단원_9차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/03/PDF 자료-지도서/3단원_9차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/03/PDF 자료-수학 익힘/3단원_9차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/03/3단원_9차시 형성평가.hwp', disabled: false },
        ],        
        // 10차시
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/03/PDF 자료-수학/3단원_10차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/03/PDF 자료-지도서/3단원_10차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '', disabled: true },
          ],
          { fileUrl: '', disabled: true },
        ],
        ...
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/03/PDF 자료-수학/3단원_11, 12차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/03/PDF 자료-지도서/3단원_11, 12차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/03/PDF 자료-수학 익힘/3단원_11, 12차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '', disabled: true },
        ],
        // 12차시
      ...
      [
        ...
        // 5차시
        [
          { fileUrl: '../../data/04/4단원_7차시 수업용 PPT.pptx', disabled: false },
          [
            ...
            { fileUrl: '../../data/04/PDF 자료-수학 익힘/4단원_7차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/04/4단원_7차시 형성평가.hwp', disabled: false },
        ],
        // 6차시
        [
        ...
        // 8차시
        [
          { fileUrl: '../../data/04/4단원_10차시 수업용 PPT.pptx', disabled: false },
          [
            ...
            { fileUrl: '../../data/04/PDF 자료-수학 익힘/4단원_10차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/04/4단원_10차시 형성평가.hwp', disabled: false },
        ],
        // 9차시
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/04/PDF 자료-수학/4단원_11차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-지도서/4단원_11차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '', disabled: true },
          ],
          { fileUrl: '', disabled: true },
        ],
        ...
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/04/PDF 자료-수학/4단원_12, 13차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-지도서/4단원_12, 13차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-수학 익힘/4단원_12, 13차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '', disabled: true },
        ],
        // 11차시
      ...
      [
        ...
        // 5차시
        [
          { fileUrl: '../../data/05/5단원_5차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/05/PDF 자료-수학/5단원_5차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-지도서/5단원_5차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-수학 익힘/5단원_5차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/05/5단원_5차시 형성평가.hwp', disabled: false },
        ],
        // 6차시
        [
          { fileUrl: '../../data/05/5단원_6, 7차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/05/PDF 자료-수학/5단원_6, 7차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-지도서/5단원_6, 7차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-수학 익힘/5단원_6, 7차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/05/5단원_6, 7차시 형성평가.hwp', disabled: false },
        ],
        // 7차시
        [
          { fileUrl: '', disabled: true },
        ...
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/05/PDF 자료-수학/5단원_9, 10차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-지도서/5단원_9, 10차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-수학 익힘/5단원_9, 10차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '', disabled: true },
        ],
        // 9차시
      ...
      [
        ...
        // 5차시
        [
          { fileUrl: '../../data/06/6단원_5, 6차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/06/PDF 자료-수학/6단원_5, 6차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/06/PDF 자료-지도서/6단원_5, 6차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/06/PDF 자료-수학 익힘/6단원_5, 6차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/06/6단원_5, 6차시 형성평가.hwp', disabled: false },
        ],
        // 6차시
        [
          { fileUrl: '', disabled: true },
        ...
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/06/PDF 자료-수학/6단원_8, 9차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/06/PDF 자료-지도서/6단원_8, 9차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/06/PDF 자료-수학 익힘/6단원_8, 9차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '', disabled: true },
        ],
        // 8차시
