...
$.getScript(_mainUrl + "/include/js/tsherpa_note.js",
    function () {
        // 자바스크립트 로드 후 실행
        $('head').append('<link rel="stylesheet" href="' + _mainUrl + '/include/css/common.css" type="text/css" />');
        $('head').append('<link rel="stylesheet" href="' + _mainUrl + '/include/css/popup.css" type="text/css" />');
    }
);
...
function viewChunjaeMedia2(mID) {
    ...
    $(".layerPop_vid-content").append("<iframe  width=\"100%\" height=\"100%\" src='" + strURL + "' allowfullscreen></iframe>")
