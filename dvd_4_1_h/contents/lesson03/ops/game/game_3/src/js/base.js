...
function PlayFunny() {
  ...
  this.spriteAnis = [];
  this.spriteAniTimeoutId = undefined;
  ...
  this.playSpriteAni = function (selectPlayElement, type) {
    ...
    clearTimeout(this.spriteAniTimeoutId);
    spriteAni.stop();
    // spriteAni.reset();

    if (!loop) {
      this.spriteAniTimeoutId = setTimeout(
        function () {
          if (image) {
  ...
  this.endPlay = function (playingIndex) {
    this.increasePlayedCount();
    this.completeSelectPlayElement();
    playingIndex ? this.setPlayingIndex(playingIndex) : this.resetPlayingIndex();
  ...
  this.shake = function (_target, _direction, _duration, _repeatance) {
    ...
    var animation = animationName
      .concat(" ")
      .concat(animationDuration)
      .concat(" ")
      .concat(animationTimingFunction)
      .concat(" ")
      .concat(animationDelay)
      .concat(" ")
      .concat(animationIterationCount);
  ...
  // output
  window.endPlay = function (playingIndex) {
    this.endPlay(playingIndex);
  }.bind(this);
