...
function appendCoin(coinType, coinbox) {
  ...
  switch (coinType) {
    case "1000":
      coinObj.src = "images/1000won.png";
      coinName = "1000won";
      // coinObj.style.margin = "16px";
      coinObj.style.width = "136px";
      coinObj.style.margin = "2px 12px";
      coinObj.style.verticalAlign = "top";
      break;
    case "100":
...
function initCoinContainer() {
  ...
  for (var i = 0; i < gameManager.TOTAL_ANSWER_ARRAY[0]; i++) {
    ...
    appendCoin("1000", coinbox100);
  }

  coinbox100.style.width = "640px";
