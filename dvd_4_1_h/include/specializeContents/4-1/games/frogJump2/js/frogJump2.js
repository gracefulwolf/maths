...
function initBead() {
  ...
  (frogBg = document.createElement("img")), frogBg.setAttribute("id", "frogBg");
  ...
  frogBg.setAttribute("style", "top: 25%; left: 16%; z-index: 2;");
...
function startBtn(dragObj) {
  ...
  startBtn.addEventListener('mousedown', btnDown, false);
  // startBtn.addEventListener('touchstart', btnDown, false);
  startBtn.addEventListener('mouseup', btnUp, false);
  // startBtn.addEventListener('touchend', btnUp, false);
}
...
function frogMotioncorrect() {
  ...
  var frogMotion = document.createElement("img"),
    spriteArray = [
      "images/frogjump2_frog_1.png",
      "images/frogjump2_frog_2.png",
      "images/frogjump2_frog_3.png",
      "images/frogjump2_frog_4.png",
      "images/frogjump2_frog_5.png",
      "images/frogjump2_frog_6.png",
      "images/frogjump2_frog_7.png",
      "images/frogjump2_frog_8.png",
      "images/frogjump2_frog_9.png",
      "images/frogjump2_frog_10.png",
      "images/frogjump2_frog_11.png",
      "images/frogjump2_frog_12.png",
      "images/frogjump2_frog_13.png",
      "images/frogjump2_frog_14.png",
      "images/frogjump2_frog_15.png",
      "images/frogjump2_frog_16.png",
      "images/frogjump2_frog_17.png",
    ];
  frogMotion.setAttribute("id", "frogMotion");

  frogMotion.setAttribute("style", "top: 25%; left: 16%; z-index: 2;");
