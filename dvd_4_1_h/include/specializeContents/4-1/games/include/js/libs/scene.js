...
function setScaleCanvas(targetElement, zoomRate) {
  targetElement.setAttribute(
    "style",
    "-ms-transform: scale(" + zoomRate + "," + zoomRate + ");" + "-webkit-transform: scale(" + zoomRate + "," + zoomRate + ");" + "transform: scale(" + zoomRate + "," + zoomRate + ");" + "transform-origin: 0% 0%; -webkit-transform-origin: 0% 0%; -ms-transform-origin: 0% 0%;"
  );
}
...
function appendChoiceQuestion(buttonType, choiceQuestionArray, imgSrcArray) {
  ...
  switch (gameManager.choiceQuestion.length) {
    ...
    case 2:
      choiceLeft = 150;
      if (gameManager.CURRENT_TYPE === "picture") choiceLeft = 1080;
      if (gameManager.CURRENT_TYPE === "basketball") choiceLeft = 185;
      if (gameManager.CURRENT_TYPE === "compare") choiceLeft = 604;
      break;
    case 3:
      gameManager.choiceQuestion;
      choiceLeft = 60;
      if (gameManager.CURRENT_TYPE === "picture") choiceLeft = 320;
      if (gameManager.CURRENT_TYPE === "colorpencilRibbon") choiceLeft = 40;
      if (gameManager.CURRENT_TYPE === "vic_rabbitcave") choiceLeft = -42;
      if (gameManager.CURRENT_TYPE === "fishing") choiceLeft = 160;
      if (gameManager.CURRENT_TYPE === "train") choiceLeft = 210;
      if (gameManager.CURRENT_TYPE === "train2") choiceLeft = -80;
      if (gameManager.CURRENT_TYPE === "vic_submarine") choiceLeft = -80;
      if (gameManager.CURRENT_TYPE === "vic_pea") choiceLeft = -6;
      if (gameManager.CURRENT_TYPE === "numStick") choiceLeft = -55;
      if (gameManager.CURRENT_TYPE === "vic_balloon2") choiceLeft = 1080;
      if (gameManager.CURRENT_TYPE === "dessert") choiceLeft = 210;
      if (gameManager.CURRENT_TYPE === "piggyBank") choiceLeft = 1050;
      if (gameManager.CURRENT_TYPE === "piggyBank_v2") choiceLeft = 1010;
      if (gameManager.CURRENT_TYPE === "ballon") choiceLeft = 1082;
      if (gameManager.CURRENT_TYPE === "lotto") choiceLeft = 912;
      if (gameManager.CURRENT_TYPE === "vic_basketball") choiceLeft = 35;
      if (gameManager.CURRENT_TYPE === "vic_basketball") choiceLeft = 35;
      if (gameManager.CURRENT_TYPE === "lock") choiceLeft = 890;
      if (gameManager.CURRENT_TYPE === "digital_balance") choiceLeft = 1046;
      if (gameManager.CURRENT_TYPE === "pencil") choiceLeft = 1082;
      if (gameManager.CURRENT_TYPE === "beadRead") choiceLeft = -216;
      if (gameManager.CURRENT_TYPE === "camping") choiceLeft = -165;
      if (gameManager.CURRENT_TYPE === "vic_monkey") choiceLeft = 48;
      ...
      if (gameManager.CURRENT_TYPE === "mathToy") choiceLeft = 93;
      if (gameManager.CURRENT_TYPE === "vic_mathToy") choiceLeft = 95;
      break;
    case 4:
      choiceLeft = -50;
