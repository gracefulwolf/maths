...
function txtBox() {
  var startNumValue = gameManager.TOTAL_ANSWER_ARRAY[0];
  var endNumValue = gameManager.TOTAL_ANSWER_ARRAY[1];
  ...
  // 두 숫자 길이의 합이 5를 넘을 경우 font size 50px로 줄임
  if (startNumValue.toString().length + endNumValue.toString().length >= 5) {
    startNum.style.fontSize = "50px";
    divisiontxt.style.fontSize = "50px";
    endNum.style.fontSize = "50px";
  }
}
...
function correctMotion() {
  ...
  girlArray = [
    "images/mart_girl_success_1.png",
    "images/mart_girl_success_2.png",
    "images/mart_girl_success_3.png",
    "images/mart_girl.png",
    "images/mart_girl.png",
    "images/mart_girl.png",
  ];
