...
function initBasketball() {
  ...
  // opts에 따른 설정
  var opts = gameManager.TOTAL_ANSWER_ARRAY[2];

  if (opts) {
    if (opts.fontSize) {
      Question1.style.fontSize = opts.fontSize + "px";
      Question2.style.fontSize = opts.fontSize + "px";
    }
  }
}
...
function gameOver(dragObj) {
  ...
  var choiceQuestionContainer = document.querySelector("#choiceQuestionContainer").childNodes,
    ...
    spriteArray = [
      "images/basketball_goalpost_0.png",
      "images/basketball_goalpost_1.png",
      "images/basketball_goalpost_2.png",
      "images/basketball_goalpost_3.png",
      "images/basketball_goalpost_4.png",
    ],
    top = 580,
    currentTop = 100;
