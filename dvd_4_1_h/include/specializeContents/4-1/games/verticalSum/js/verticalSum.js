...
function machine() {
  ...
  if (gameManager.QUIZ_OPTION.length === 5) {
    left = 900;
  }
  for (var i = 0; i < gameManager.QUIZ_OPTION.length; i++) {
...
function appendQuiz() {
  ...
  if (gameManager.QUIZ_OPTION.length === 5) {
    swWrapper.style.width = "520px";
    swWrapper.style.left = "385px";
    quizText_1.style.left = "380px";
    quizText_2.style.left = "480px";
  } else if (gameManager.QUIZ_OPTION.length === 4) {
    swWrapper.style.width = "420px";
    swWrapper.style.left = "405px";
  ...
  document
    ...
    .setAttribute(
      "style",
      "top : " + getRealOffsetTop(doneBtn) + "px; left :" + getRealOffsetLeft(doneBtn) + "px; background:url(../include/images/common/checkBtnRed_on.png) no-repeat;"
    );
}
