function initScene() {
  ...
  appendImageElement("animal", "images/catfood_1.png", bgCanvas, "abso");
...
function gameOver(dragObj, x, y) {
  ...
  streamSound.setSound("media/weighing_success.mp3");
...
function animalMotioncorrect() {
  ...
  correct = ["images/catfood_1_success_1.png", "images/catfood_1_success_2.png", "images/catfood_1_success_3.png", "images/catfood_1_success_4.png"];
  spriteAnimation(correct, animal);
}
function animalMotionIncorrect() {
  var animal = document.querySelector("#animal"),
    incorrect = ["images/catfood_1_fail_1.png", "images/catfood_1_fail_2.png", "images/catfood_1_fail_3.png", "images/catfood_1_fail_3.png"];
  spriteAnimation(incorrect, animal);
  streamSound.setSound("media/weighing_fail.mp3");

  setTimeout(function () {
    animal.src = "images/catfood_1.png";
  }, 1000);
