                ...
                $ts.loadScriptFile("../common/contents/js/" + a + ".js", function () {
                    ...
                    $(document).ready(function(){
                        ...
                        * */
                        ...
                        $(".cl_mainContainer a.search").on("click", function(e){
                            ...
                            var fileName = "T:/tsherpa/Tsherpa2021/element/교과학습/수학 확인문제/"+makePreviewFileName();
                    ...
                    * */
                    function makePreviewFileName(){
                        ...
                        //차시 구분
                        var order = (htmlFileNameSplit[4].substr(1,1) == "0") ? "0"+parseInt(htmlFileNameSplit[4]) : htmlFileNameSplit[4];
                        ...
                        var finalFileName = "3~4학년군_수학("+firstName+")"+grade+"_확인문제_"+chapter+"_"+order+"차시.pdf";
                    ...
                    * */
                    ...
                    function countNum ( num ) {
                        ...
                        for(let k = 0; k < num; k++) {
                            $('.basicSlider_tabs li').eq(k).css('display', 'block');
                        }
                    }
