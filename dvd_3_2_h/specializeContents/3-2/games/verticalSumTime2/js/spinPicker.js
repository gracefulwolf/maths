...
function isDownEvent(e) {
	return ['touchstart', 'mousedown'].indexOf(e.type) > -1;
}

function isUpEvent(e) {
	return ['touchup', 'mouseup'].indexOf(e.type) > -1;
}

function isMoveEvent(e) {
	return ['touchmove', 'mousemove'].indexOf(e.type) > -1;
}

function isOutEvent(e) {
	return ['touchleave', 'mouseout'].indexOf(e.type) > -1;
}
    ...
    spinPicker = {
      ...
      create: function () {
        ...
        for (l = 0; l < this.slotData.length; l += 1) {
          ...
          if (l == 0) div.style.paddingLeft = 100 * (3 - gameManager.QUIZ_OPTION[0].length) + "px";
          if (l == gameManager.QUIZ_OPTION[0].length) div.style.paddingLeft = 100 * (3 - gameManager.QUIZ_OPTION[1].length) + 100 + "px";
        ...
        document.querySelector(".doneBtn").addEventListener('mouseup', this, false);
        // document.querySelector(".doneBtn").addEventListener('touchend', this, false);

        this.swBg.addEventListener('mousedown', this, false);
        // this.swBg.addEventListener('touchstart', this, false);
      },
      ...
      destroy: function () {
        ...
        this.swBg.removeEventListener('mousedown', this, false);
        // this.swBg.removeEventListener('touchstart', this, false);
      ...
      scrollStart: function (e) {
        ...
        if (this.activeSlot !== null) {
          if (this.slotData[this.activeSlot].style.match("readonly")) {
            this.swBg.removeEventListener('mousemove', this, false);
            // this.swBg.removeEventListener('touchmove', this, false);
            this.swBg.removeEventListener('mouseup', this, false);
            // this.swBg.removeEventListener('touchend', this, false);
            return false;
          }
          ...
          var theTransform = this.slotEl[this.activeSlot].now || 0;
          ...
          this.swBg.addEventListener('mousemove', this, false);
          // this.swBg.addEventListener('touchmove', this, false);
          this.swBg.addEventListener('mouseup', this, false);
          // this.swBg.addEventListener('touchend', this, false);
      ...
      scrollMove: function (e) {
        ...
        if (this.activeSlot !== null) {
          ...
          this.swBg.addEventListener('mouseout', this, false);
          // this.swBg.addEventListener('touchleave', this, false);
        }
      },

      scrollEnd: function (e) {
        streamSound.setSound("../include/media/spinSound.mp3");
        ...
        this.swBg.removeEventListener('mouseout', this, false);
        // this.swBg.removeEventListener('touchleave', this, false);
