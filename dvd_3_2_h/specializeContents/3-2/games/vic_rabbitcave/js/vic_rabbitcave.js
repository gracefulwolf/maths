function initScene() {
  ...
  circleAnswer.setAttribute("style", "top: 300px; left: 885px; z-index: 1;");
...
function rabbitCorrMotion() {
  ...
  correctArray = [
    "images/vic_rabbitcave_rabbit_success_1.png",
    "images/vic_rabbitcave_rabbit_success_2.png",
    "images/vic_rabbitcave_rabbit_success_3.png",
    "images/vic_rabbitcave_rabbit_success_3.png",
  ];
...
function rabbitIncorrMotion() {
  ...
  incorrectArray = [
    "images/vic_rabbitcave_rabbit_fail_1.png",
    "images/vic_rabbitcave_rabbit_fail_2.png",
    "images/vic_rabbitcave_rabbit_fail_3.png",
    "images/vic_rabbitcave_rabbit_fail_3.png",
  ];
