function initScene() {
  ...
  circleImg.style.background = "url(../include/images/common/" + gameManager.QUIZ_OPTION[1][0] + "/" + gameManager.QUIZ_OPTION[1][1] + ".png)";
  ...
  var dropAreaOffsetLeft = QS(".drop").offsetLeft;
  var count = 0;
  ...
  var ivId = setInterval(function() {
    ...
    if (dropAreaOffsetLeft !== QS(".drop").offsetLeft) {
      setDropAreaRect();
      clearInterval(ivId);
    }
  });

  function setDropAreaRect() {
