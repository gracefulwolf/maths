function initScene() {
  ...
  if (queLength1 >= 2 || queLength2 >= 2 || queLength3 >= 2) {
    ...
    answerObject.setAttribute("style", "z-index: 1; position: absolute; top: 340px; left: 457px;");
    ...
    answerObject.setAttribute("style", "z-index: 1; position: absolute; top: 340px; left: 528px;");
  }
  ...
  for (var i = 0; i < choiceQuestionContainer.length; i++) {
    ...
    console.log(queLength1);
    if (queLength1 === 2) {
      choiceQuestionContainer[i].style.textAlign = "left";
      choiceQuestionContainer[i].style.paddingLeft = "30px";
    } else {
...
function createQueCounter() {
  ...
  if (a1 >= 2 || a2 >= 2 || a3 >= 2) {
    txt2.style.left = "243px";
    txt2.style.letterSpacing = "16px";
  }
...
function appendSelectQuestion(buttonType, choiceQuestionArray, imgSrcArray) {
  ...
  for (var i = 0; i < choiceQuestionArray.length; i++) {
    ...
    if (imgSrcArray) {
      ...
      if (a1 >= 2 || a2 >= 2 || a3 >= 2) {
        console.log("[!!]", choiceQuestionGroup);
        choiceQuestionGroup.style.letterSpacing = "16px";
      }
    } else {
