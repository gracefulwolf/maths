function initScene() {
  ...
  gameManager.compingImgArray = [
    "images/campingcar_trailer_" + randResult[0] + "_1.png",
    "images/campingcar_trailer_" + randResult[0] + "_2.png",
    "images/campingcar_connect_" + randResult[0] + ".png",
  ];
  gameManager.compingCarArray = [
    "images/campingcar_car_" + randResult[1] + ".png",
    "images/campingcar_car_" + randResult[2] + ".png",
    "images/campingcar_car_" + randResult[3] + ".png",
  ];
  ...
  for (var i = 0; i < gameManager.campingTextArray.length; i++) {
    ...
    document
      .querySelector("#compingBar_" + i)
      .setAttribute("style", "top:" + (gameManager.compingPosition[i][0] + 40) + "px; left:" + (gameManager.compingPosition[i][1] + 160) + "px;");
