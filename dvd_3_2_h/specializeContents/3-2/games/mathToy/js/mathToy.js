...
function handMotion() {
  ...
  (calculationImg = document.querySelector("#calculation").childNodes[0]), (backSeat = document.querySelector("#backSeat"));
...
function gameOver(dragObj) {
  ...
  document
    ...
    .setAttribute("style", "position: absolute; display: block; top:" + (dragObj.offsetTop + 20) + "px; left:" + (dragObj.offsetLeft + 70) + "px;");
