function initScene() {
  ...
  circleAnswer.setAttribute("style", "top:206px; left: 436px");
  triangleAnswer.setAttribute("style", "top:361px; left: 106px");
  finalAnswer.setAttribute("style", "top:516px; left: 601px");
...
function initNumber() {
  var NEW_NUMBERS = [1, 3, 9, 27, 2, 6, 18, 54, 3, 9, 27, 81, 4, 12, 36, 108];
  ...
  var numberTexts = document.querySelectorAll(".numberText");
  for (var i = 0; i < numberTexts.length; i++) {
    numberTexts[i].innerHTML = NEW_NUMBERS[i];
  }
