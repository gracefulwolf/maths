...
function initDrawNumber () {
	...
	var number = Raphael("number", 500, 500),
		...
		numberPath[0].addEventListener('mousedown', start, false);		
		// numberPath[0].addEventListener('touchstart', start, false);		
		numberPath[0].addEventListener('mousemove', move, false);
		// numberPath[0].addEventListener('touchmove', move, false);
		numberPath[0].addEventListener('mouseup', end, false);
		// numberPath[0].addEventListener('touchend', end, false);
		numberPath[0].addEventListener('mouseout', end, false);
		// numberPath[0].addEventListener('touchleave', end, false);
}
