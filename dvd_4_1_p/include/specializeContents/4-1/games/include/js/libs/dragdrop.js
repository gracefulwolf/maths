...
function boundingCircle(dragObj, x, y) {
  ...
  switch (gameManager.CURRENT_TYPE) {
    case "donut":
      ...
      if (
        x + adjustPosition > answerObj1.offsetLeft * gameManager.zoomRate &&
        x < (answerObj1.offsetLeft + adjustPosition) * gameManager.zoomRate + (answerObj1.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPosition > answerObj1.offsetTop * gameManager.zoomRate &&
        y < (answerObj1.offsetTop + adjustPosition) * gameManager.zoomRate + (answerObj1.clientHeight + 10) * gameManager.zoomRate &&
        answerChildNode1 <= currentAnswer1
      ) {
        log("bounding!");
        ...
        x + adjustPosition > answerObj2.offsetLeft * gameManager.zoomRate &&
        x < (answerObj2.offsetLeft + adjustPosition) * gameManager.zoomRate + (answerObj2.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPosition > answerObj2.offsetTop * gameManager.zoomRate &&
        y < (answerObj2.offsetTop + adjustPosition) * gameManager.zoomRate + (answerObj2.clientHeight + 10) * gameManager.zoomRate &&
        answerChildNode2 <= currentAnswer2
      ) {
        log("bounding!");
    ...
    case "vic_donutA":
      ...
      if (
        ...
        y + adjustPosition > answerObj2.offsetTop * gameManager.zoomRate &&
        y < (answerObj2.offsetTop + adjustPosition) * gameManager.zoomRate + (answerObj2.clientHeight + 10) * gameManager.zoomRate &&
        answerChildNode2 <= currentAnswer1
      ) {
        log("bounding!");
    ...
    case "vic_donutB":
      ...
      if (
        ...
        x + adjustPosition > answerObj3.offsetLeft * gameManager.zoomRate &&
        x < (answerObj3.offsetLeft + adjustPosition) * gameManager.zoomRate + (answerObj3.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPosition > answerObj3.offsetTop * gameManager.zoomRate &&
        y < (answerObj3.offsetTop + adjustPosition) * gameManager.zoomRate + (answerObj3.clientHeight + 10) * gameManager.zoomRate &&
        answerChildNode3 <= currentAnswer1
      ) {
        log("bounding!");
    ...
    case "cake":
      ...
      if (
        x + adjustPositionCake > answerObject1.offsetLeft * gameManager.zoomRate &&
        x < (answerObject1.offsetLeft + adjustPositionCake) * gameManager.zoomRate + (answerObject1.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPositionCake > answerObject1.offsetTop * gameManager.zoomRate &&
        y < (answerObject1.offsetTop + adjustPositionCake) * gameManager.zoomRate + (answerObject1.clientHeight + 10) * gameManager.zoomRate &&
        circleAnswer === dragObjAnser
      ) {
        ...
        x + adjustPositionCake > answerObject2.offsetLeft * gameManager.zoomRate &&
        x < (answerObject2.offsetLeft + adjustPositionCake) * gameManager.zoomRate + (answerObject2.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPositionCake > answerObject2.offsetTop * gameManager.zoomRate &&
        y < (answerObject2.offsetTop + adjustPositionCake) * gameManager.zoomRate + (answerObject2.clientHeight + 10) * gameManager.zoomRate &&
        triangleAnswer === dragObjAnser
      ) {
    ...
    case "cakeThree":
      ...
      if (
        ...
        x + adjustPositionCake > answerObject3.offsetLeft * gameManager.zoomRate &&
        x < (answerObject3.offsetLeft + adjustPositionCake) * gameManager.zoomRate + (answerObject3.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPositionCake > answerObject3.offsetTop * gameManager.zoomRate &&
        y < (answerObject3.offsetTop + adjustPositionCake) * gameManager.zoomRate + (answerObject3.clientHeight + 10) * gameManager.zoomRate &&
        finalAnswer === dragObjAnser
      ) {
    ...
    case "soccer":
      var spriteArray = [
          "images/soccer_goalpost_0.png",
          "images/soccer_goalpost_1.png",
          "images/soccer_goalpost_2.png",
          "images/soccer_goalpost_3.png",
          "images/soccer_goalpost_2.png",
          "images/soccer_goalpost_3.png",
          "images/soccer_goalpost_4.png",
        ],
        dragObjPosition = dragObj,
    ...
    case "soccer2":
      ...
      if (
        ...
        x + adjustPositionCake > answerObject3.offsetLeft * gameManager.zoomRate &&
        x < (answerObject3.offsetLeft + adjustPositionCake) * gameManager.zoomRate + (answerObject2.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPositionCake > answerObject2.offsetTop * gameManager.zoomRate &&
        y < (answerObject3.offsetTop + adjustPositionCake) * gameManager.zoomRate + (answerObject3.clientHeight + 10) * gameManager.zoomRate &&
        finalAnswer === dragObjAnser
      ) {
    ...
    case "basketball":
      ...
      if (
        x + adjustPosition > answerObj.offsetLeft * gameManager.zoomRate &&
        x < (answerObj.offsetLeft + adjustPosition) * gameManager.zoomRate + (answerObj.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPosition > answerObj.offsetTop * gameManager.zoomRate &&
        y < (answerObj.offsetTop + adjustPosition2) * gameManager.zoomRate + (answerObj.clientHeight + 10) * gameManager.zoomRate
      ) {
        log("bounding!");

        var dragObjTop = answerObj.style.top.replace("px", "");
        (dragObjTop = parseInt(dragObjTop) + 110), (adjustLeft = 0), (adjustTop = 0);
    ...
    case "puzzle":
      ...
      if (
        ...
        x < (answerObj.offsetLeft + adjustPosition) * gameManager.zoomRate + (answerObj.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPosition > answerObj.offsetTop * gameManager.zoomRate &&
        y < (answerObj.offsetTop + adjustPosition) * gameManager.zoomRate + (answerObj.clientHeight + 10) * gameManager.zoomRate
      ) {
        log("bounding!");
    ...
    case "vic_scale1":
      ...
      if (
        x + adjustPosition > answerObject_1.offsetLeft * gameManager.zoomRate &&
        x < (answerObject_1.offsetLeft + adjustPosition) * gameManager.zoomRate + (answerObject_1.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPosition > answerObject_1.offsetTop * gameManager.zoomRate &&
        y < (answerObject_1.offsetTop + adjustPosition) * gameManager.zoomRate + (answerObject_1.clientHeight + 10) * gameManager.zoomRate
      ) {
        ...
        x + adjustPosition > answerObject_2.offsetLeft * gameManager.zoomRate &&
        x < (answerObject_2.offsetLeft + adjustPosition) * gameManager.zoomRate + (answerObject_2.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPosition > answerObject_2.offsetTop * gameManager.zoomRate &&
        y < (answerObject_2.offsetTop + adjustPosition) * gameManager.zoomRate + (answerObject_2.clientHeight + 10) * gameManager.zoomRate
      ) {
    ...
    case "vic_scale2":
      ...
      if (
        ...
        x + adjustPosition > answerObject_3.offsetLeft * gameManager.zoomRate &&
        x < (answerObject_3.offsetLeft + adjustPosition) * gameManager.zoomRate + (answerObject_3.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPosition > answerObject_3.offsetTop * gameManager.zoomRate &&
        y < (answerObject_3.offsetTop + adjustPosition) * gameManager.zoomRate + (answerObject_3.clientHeight + 10) * gameManager.zoomRate
      ) {
    ...
    case "mart":
      ...
      if (
        answerObj != null &&
        x + adjustPosition > answerObj.offsetLeft * gameManager.zoomRate &&
        x < (answerObj.offsetLeft + adjustPosition) * gameManager.zoomRate + (answerObj.clientWidth + 70) * gameManager.zoomRate &&
        y + adjustPosition > answerObj.offsetTop * gameManager.zoomRate &&
        y < (answerObj.offsetTop + adjustPosition) * gameManager.zoomRate + (answerObj.clientHeight + 70) * gameManager.zoomRate
      ) {
        log("bounding!");
        var dragObjTop = answerObj.style.top.replace("px", "");
        (dragObjTop = parseInt(dragObjTop) + 110), (adjustLeft = 0), (adjustTop = 0);
    ...
    case "seeSaw":
      ...
      if (
        ...
        x + adjustPosition > answerObj.offsetLeft * gameManager.zoomRate &&
        x < (answerObj.offsetLeft + adjustPosition) * gameManager.zoomRate + (answerObj.clientWidth + 10) * gameManager.zoomRate &&
        y + adjustPosition > (answerObj.offsetTop + 450) * gameManager.zoomRate &&
        y < (answerObj.offsetTop + 300 + adjustPosition) * gameManager.zoomRate + (answerObj.clientHeight + 10) * gameManager.zoomRate
      ) {
        log("bounding!");

        var dragObjTop = answerObj.style.top.replace("px", "");
        (dragObjTop = parseInt(dragObjTop) + 180), (adjustLeft = -15), (adjustTop = 165);
    ...
    default:
      ...
      if (gameManager.CURRENT_TYPE === "parking") adjustPosition = 0;
