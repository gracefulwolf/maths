...
function gameOverAnimation() {
  ...
  switch (gameManager.iconName) {
    case "heart":
      starObj.src = "../include/images/heartBig.png";
      break;
    case "star":
      starObj.src = "../include/images/starBig.png";
      break;
  }
  ...
  if (bgCanvasElementStyleLeft !== 285) bgCanvasElementStyleLeft = 350;
...
function incorrectAnimation(dragObj) {
  ...
  if (
    gameManager.CURRENT_TYPE === "click" ||
    gameManager.CURRENT_TYPE === "fraction_bti" ||
    gameManager.CURRENT_TYPE === "vic_squirrel" ||
    gameManager.CURRENT_TYPE === "grapetree" ||
    gameManager.CURRENT_TYPE === "chocobox" ||
    gameManager.CURRENT_TYPE === "numStick" ||
    gameManager.CURRENT_TYPE === "divide_selection" ||
    gameManager.CURRENT_TYPE === "train" ||
    gameManager.CURRENT_TYPE === "archery" ||
    gameManager.CURRENT_TYPE === "train2" ||
    gameManager.CURRENT_TYPE === "vic_submarine" ||
    gameManager.CURRENT_TYPE === "vic_rabbitcave" ||
    gameManager.CURRENT_TYPE === "vic_pea" ||
    gameManager.CURRENT_TYPE === "train5Row" ||
    gameManager.CURRENT_TYPE === "vic_monkey" ||
    gameManager.CURRENT_TYPE === "bead" ||
    gameManager.CURRENT_TYPE === "donut" ||
    gameManager.CURRENT_TYPE === "vic_donutA" ||
    gameManager.CURRENT_TYPE === "vic_donutB" ||
    gameManager.CURRENT_TYPE === "chocoplate" ||
    gameManager.CURRENT_TYPE === "vic_pizza" ||
    gameManager.CURRENT_TYPE === "candle" ||
    gameManager.CURRENT_TYPE === "beadRead" ||
    gameManager.CURRENT_TYPE === "dessert" ||
    gameManager.CURRENT_TYPE === "camping" ||
    gameManager.CURRENT_TYPE === "block" ||
    gameManager.CURRENT_TYPE === "block_mult" ||
    gameManager.CURRENT_TYPE === "picture" ||
    gameManager.CURRENT_TYPE === "basketball" ||
    gameManager.CURRENT_TYPE === "vic_basketball" ||
    gameManager.CURRENT_TYPE === "vic_bowling" ||
    gameManager.CURRENT_TYPE === "colorpencilRibbon" ||
    gameManager.CURRENT_TYPE === "dogFoodTwo" ||
    gameManager.CURRENT_TYPE === "vic_dogCatFoodA" ||
    gameManager.CURRENT_TYPE === "vic_rabbit" ||
    gameManager.CURRENT_TYPE === "vic_balloon2" ||
    gameManager.CURRENT_TYPE === "vic_soccer" ||
    gameManager.CURRENT_TYPE === "vic_carterp" ||
    gameManager.CURRENT_TYPE === "vic_fancylamp" ||
    gameManager.CURRENT_TYPE === "block_multi"
  )
    currentTop = 100;

  if (gameManager.CURRENT_TYPE === "scale" || gameManager.CURRENT_TYPE === "mathToy" || gameManager.CURRENT_TYPE === "vic_mathToy") currentTop = 20;

  if (
    gameManager.CURRENT_TYPE === "piggyBank" ||
    gameManager.CURRENT_TYPE === "lotto" ||
    gameManager.CURRENT_TYPE === "lock" ||
    gameManager.CURRENT_TYPE === "pencil" ||
    gameManager.CURRENT_TYPE === "busstop" ||
    gameManager.CURRENT_TYPE === "busstop_A" ||
    gameManager.CURRENT_TYPE === "vic_scale1" ||
    gameManager.CURRENT_TYPE === "vic_scale2" ||
    gameManager.CURRENT_TYPE === "puzzle" ||
    gameManager.CURRENT_TYPE === "ballon2" ||
    gameManager.CURRENT_TYPE === "fruitsBox" ||
    gameManager.CURRENT_TYPE === "animalFence" ||
    gameManager.CURRENT_TYPE === "bus" ||
    gameManager.CURRENT_TYPE === "motorcycle" ||
    gameManager.CURRENT_TYPE === "vic_slide" ||
    gameManager.CURRENT_TYPE === "chocodivide" ||
    gameManager.CURRENT_TYPE === "seeSaw"
  ) {
  ...
  if (
    gameManager.CURRENT_TYPE === "robot1" ||
    gameManager.CURRENT_TYPE === "robot2" ||
    gameManager.CURRENT_TYPE === "dogFoodTwo" ||
    gameManager.CURRENT_TYPE === "vic_dogCatFoodA" ||
    gameManager.CURRENT_TYPE === "vic_rabbit" ||
    gameManager.CURRENT_TYPE === "vic_balloon2"
  ...
  if (
    gameManager.CURRENT_TYPE === "dollshooting" ||
    gameManager.CURRENT_TYPE === "vic_submarine" ||
    gameManager.CURRENT_TYPE === "vic_rabbitcave" ||
    gameManager.CURRENT_TYPE === "target" ||
    gameManager.CURRENT_TYPE === "target2" ||
    gameManager.CURRENT_TYPE === "target3" ||
    gameManager.CURRENT_TYPE === "vic_pea"
  ) {
    var left = gameManager.choiceQuestionPosition[dragObjId[1]][1];
    currentLeft = 100;
...
function addIdleSprite(delay, spriteObj, spriteArray) {
  var index = 0,
    idle = setInterval(function () {
      if (index < spriteArray.length - 1) index++;
      else index = 0;
...
function starDust(starObj) {
  ...
  switch (gameManager.iconName) {
    case "heart":
      starDustObj.src = "../include/images/heartDust_" + starDustRnd + ".png";
      break;
    case "star":
      starDustObj.src = "../include/images/starDust_" + starDustRnd + ".png";
      break;
  }
  ...
  if (parseInt(Math.random() * 10) < 1 && top < 400) document.querySelector("#bgCanvas").appendChild(starDustObj);
}
