function initScene() {
  ...
  for (var i = 0; i < gameManager.trainTextArray.length; i++) {
    ...
    trainText.style.lineHeight = "48px";
    trainText.style.letterSpacing = "-0.05em";
...
function appendSelectQuestion(buttonType, choiceQuestionArray, imgSrcArray) {
  ...
  for (var i = 0; i < choiceQuestionArray.length; i++) {
    ...
    document.querySelector("#answerObject1").style.left = "416px";
    document.querySelector("#train_1").style.left = "278px";
    document.querySelector("#train_1 + .trainText").style.left = "296px";
...
function contrastAnswer(dragObj) {
  ...
  if (count === gameManager.CURRENT_ANSWER.length) {
    if (gameManager.CURRENT_ANSWER[0] === answerObj1.getAttribute("candlevalue") && gameManager.CURRENT_ANSWER[1] === answerObj2.getAttribute("candlevalue")) {
      // streamSound.setSound('../include/media/cake/orgel.mp3');
