...
function initCoin() {
  ...
  questionTxt.innerHTML = gameManager.TOTAL_ANSWER_ARRAY[0] + "만";
...
function gameOver() {
  var coinNum1000 = parseInt(document.querySelector("#coinText_0").innerHTML.replace("만", ""));
  var coinNum100 = parseInt(document.querySelector("#coinText_1").innerHTML.replace("만", ""));
  var coinNum10 = parseInt(document.querySelector("#coinText_2").innerHTML.replace("만", ""));
  var coinNum1 = parseInt(document.querySelector("#coinText_3").innerHTML.replace("만", ""));
  ...
  var isAnswered = coinNum1000 === gameManager.CURRENT_ANSWER[0] && coinNum100 === gameManager.CURRENT_ANSWER[1] && coinNum10 === gameManager.CURRENT_ANSWER[2] && coinNum1 === gameManager.CURRENT_ANSWER[3];
...
function appendCoin(index, coinMachine) {
  ...
  switch (index) {
    ...
    case 0:
      ...
      coinText.innerHTML = gameManager.coinArray1000.length * 1000 + "만";
      if (!gameManager.coinArray1000.length) {
        coinText.innerHTML = coinText.innerHTML.replace("만", "");
      }
    ...
    case 1:
      ...
      coinText.innerHTML = gameManager.coinArray100.length * 100 + "만";
      if (!gameManager.coinArray100.length) {
        coinText.innerHTML = coinText.innerHTML.replace("만", "");
      }
    ...
    case 2:
      ...
      coinText.innerHTML = gameManager.coinArray10.length * 10 + "만";
      if (!gameManager.coinArray10.length) {
        coinText.innerHTML = coinText.innerHTML.replace("만", "");
      }
    ...
    case 3:
      ...
      coinText.innerHTML = gameManager.coinArray1.length + "만";
      if (!gameManager.coinArray1.length) {
        coinText.innerHTML = coinText.innerHTML.replace("만", "");
      }
