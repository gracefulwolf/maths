    ...
    var i = "dragObjComplete"
        ...
        return _createClass(r, [{
            ...
            value: function(e, t) {
                ...
                this.TOTAL_COUNT++,
                this.QUIZ.option.copy || (n.disable(!0),
                    r.dragObjCompleteClass(n, !0)),
                    this.copyObj(),
                    r.completeArea(a),
            ...
            value: function(e, t) {
                ...
                r.dragObjCompleteClass(o, !0),
                    a.element.appendChild(o)
            }
        }, {
            key: "showAnswer",
            value: function() {
                ...
                e.forEach(function(t) {
                    a.forEach(function(e) {
                        n.checkAnswers(t, e) && (r.dropAreaHasCopied(t, e) || (n.copyObj(t, e),
                            r.dragObjCompleteClass(t, !0))),
                            e.disable(!0)
                    }),
                        t.disable(!0)
                })
            ...
            value: function() {
                this.game.dropAreas.forEach(function(e) {
                    for (var t, n = e.element.querySelectorAll(".".concat(i)), a = 0, o = n.length; a < o; a++)
                        t = n[a],
            ...
            value: function() {
                console.log("checkTotalComplete ".concat(this.TOTAL_COUNT, " : ").concat(this.TOTAL_COMPLETE_COUNT)),
                this.TOTAL_COUNT === this.TOTAL_COMPLETE_COUNT && (console.log("끝!"),
            ...
            value: function(e) {
                ...
                n && o ? (a.endCorrect(),
                    window.$efSound.correct()) : (a.endWrong(),
            ...
            value: function(e, t) {
                for (var n, a = t.element.children, o = 0, r = a.length; o < r; o++)
                    if (n = a[o],
                    e.element.className === n.className)
                        return !0;
                return !1
            }
        }]),
