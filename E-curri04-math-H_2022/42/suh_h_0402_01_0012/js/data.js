      ...
      listWord : [
        {
          title: '막대그래프',
          page : 113,
          means : '자료를 막대 모양으로 나타낸 그래프',
          example : ['자료를 막대 모양으로 나타낸 그래프를 막대그래프라고 합니다.','막대그래프에서는 막대를 가로 또는 세로로 나타낼 수 있습니다.'],
    ...
    },
    {
      ...
      listWord : [
        ...
        },
        {
          title: '평행선 사이의 거리',
          page : 90,
          means : '<span style="letter-spacing: -1.5px;">아래 그림과 같이 평행선에 수직인 선분의 길이</span>',
          example : ['그림과 같이 평행선에 수직인 선분의 길이를 평행선 사이의 거리라고 합니다.','평행선 사이의 거리는 두 직선의 가장 가까운 거리입니다.'],
      ...
      listWord : [
        {
          title: '꺾은선그래프',
          page : 111,
          means : '연속적으로 변화하는 양을 점으로 표시하고 그 점들을 선분으로 이어 그린 그래프',
          example : ['참고 그림의 그래프와 같이 연속적으로 변화하는 양을 점으로 표시하고 그 점들을 선분으로 이어 그린 그래프를 꺾은선그래프라고 합니다.','꺾은선그래프로 나타내면 대체로 어떻게 변하고 있는지 알 수 있습니다.'],
