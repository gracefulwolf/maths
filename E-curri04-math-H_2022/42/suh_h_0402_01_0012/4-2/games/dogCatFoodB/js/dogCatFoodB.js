...
function initBead(frogBg) {
  ...
  foodShadow.setAttribute("style", "position:absolute; top: 43%; left:355px;");

  frogBg.setAttribute("style", "top: 43%; left:355px;");
  ...
  for (var i = 0; i < choiceQuestionArray.length; i++) {
    ...
    if (imgSrcArray) {
      ...
      if (typeof choiceQuestionValue === "string") {
        ...
        imgObjText.style.transform = "translate(10px, 22px)";
...
function frogMotioncorrect() {
  ...
  frogMotion.setAttribute("style", "top: 43%; left:355px; z-index: 0;");
