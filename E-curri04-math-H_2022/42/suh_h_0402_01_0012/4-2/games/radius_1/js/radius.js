function initScene() {
  ...
  // var circleImg = createElement("div", bgCanvas, "circleImg");
  // var circleBg = createElement("div", circleImg, "circleBg");
  // var radiusLine_0 = createElement("div", bgCanvas, "radiusLine radiusLine_0");
  // var radiusLine_1 = createElement("div", bgCanvas, "radiusLine radiusLine_1");
  // var intX = Math.floor(Math.random() * 5 + 1);
  ...
  // 이미지 영역
  var IMAGE_DATAS = gameManager.QUIZ_OPTION[0];
  var imgSrc = IMAGE_DATAS[0];
  var imgPositions = IMAGE_DATAS[1];
  var imgHeight = IMAGE_DATAS[2];
  ...
  // 텍스트 영역
  var TEXT_DATA = IMAGE_DATAS[3];
  if (TEXT_DATA) {
    var textElement = document.createElement("div");
    var dropAreaRegExp = /\[dropArea\]/g;
    var dropAreaHTML = "<div id='dropAreaInText' style='";
    dropAreaHTML += "display: inline-block;";
    dropAreaHTML += " width: 200px;";
    dropAreaHTML += " height: 102px;";
    dropAreaHTML += " vertical-align: top;";
    dropAreaHTML += "'></div>";

    textElement.style.position = "absolute";
    textElement.style.top = "430px";
    textElement.style.left = "130px";
    textElement.style.width = "1040px";
    textElement.style.fontFamily = "NanumGothicExtraBold";
    textElement.style.fontSize = "50px";
    textElement.style.lineHeight = "102px";
    textElement.style.textAlign = "center";

    if (dropAreaRegExp.test(TEXT_DATA)) {
      TEXT_DATA = TEXT_DATA.replace(dropAreaRegExp, dropAreaHTML);
    }

    textElement.innerHTML = TEXT_DATA;

    bgCanvas.appendChild(textElement);
  }

  // 드롭 영역
  var DROP_POSITIONS = gameManager.QUIZ_OPTION[1];
  for (var i = 0; i < gameManager.QUIZ_ANSWER.length; i++) {
    ...
    if (TEXT_DATA) {
      (function positioningDropArea(dropArea) {
        var dropAreaInText = document.querySelector("#dropAreaInText");
        var intervalId;
        var left;
        var top;
        var intervalCount = 0;
        ...
        intervalId = setInterval(function () {
          var referenceRect = dropAreaInText.getBoundingClientRect();
          
          if (left !== referenceRect.left || top !== referenceRect.top) {
            left = referenceRect.left;
            top = referenceRect.top;
            
            setElLeftTop(dropArea, left, top);
          }
      ...
      // setTimeout(function () {
      //   var dropAreaInText = document.querySelector("#dropAreaInText");
      //   dropArea.style.left = dropAreaInText.getBoundingClientRect().left + "px";
      //   dropArea.style.top = dropAreaInText.getBoundingClientRect().top + "px";
      // }, 100);
    } else {
      dropArea.style.left = DROP_POSITIONS[0] + "px";
      dropArea.style.top = DROP_POSITIONS[1] + "px";
    }
  }
  // switch (intX) {
  //   case 1:
...
function setElLeftTop(el, left, top) {
...
function radiusChage() {
  var circleBg = document.querySelector(".circleBg"),
    circleImgInt = circleBg && circleBg.style.background.split(".")[0],
  ...
  if (radiusLine_0) radiusLine_0.style.opacity = 1;
  if (radiusLine_1) radiusLine_1.style.opacity = 1;

  if (circleBg) circleBg.style.opacity = 0;

  if (intY == 1) {
    if (circleText_0) circleText_0.style.top = "202px";
    if (circleText_0) circleText_0.style.left = "540px";
    if (circleText_1) circleText_1.style.top = "203px";
    if (circleText_1) circleText_1.style.left = "693px";
  } else if (intY == 2) {
    if (circleText_0) circleText_0.style.top = "202px";
    if (circleText_0) circleText_0.style.left = "540px";
    if (circleText_1) circleText_1.style.top = "203px";
    ...
    if (circleText_0) circleText_0.style.top = "314px";
    if (circleText_0) circleText_0.style.left = "540px";
    if (circleText_1) circleText_1.style.top = "311px";
    if (circleText_1) circleText_1.style.left = "693px";
  } else if (intY == 4) {
    if (circleText_0) circleText_0.style.top = "202px";
    if (circleText_0) circleText_0.style.left = "489px";
    if (circleText_1) circleText_1.style.top = "143px";
    if (circleText_1) circleText_1.style.left = "660px";
  } else if (intY == 5) {
    if (circleText_0) circleText_0.style.top = "299px";
    if (circleText_0) circleText_0.style.left = " 554px";
    if (circleText_1) circleText_1.style.top = "213px";
    if (circleText_1) circleText_1.style.left = "435px";
  }
}
