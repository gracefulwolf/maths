function initScene() {
  ...
  colorNum = colorNum.sort(function () {
    return 0.5 - Math.random();
  });
  random = random.sort(function () {
    return 0.5 - Math.random();
  });
  ...
  switch (gameManager.QUIZ_OPTION[0]) {
    ...
    case "house":
      ...
      break;
    case "candleLight":
      array = ["big_triangle_" + colorNum[0], "middle_triangle_" + colorNum[1], "small_triangle_" + colorNum[0], "small_triangle_" + colorNum[1], "parallelogram_" + colorNum[0]];
      break;
    case "tree":
