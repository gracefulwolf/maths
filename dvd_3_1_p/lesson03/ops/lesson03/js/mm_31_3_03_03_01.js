...
var PAGE_DEPTH = { vi: 0, pi: 2, ci: 3, si: 2, ti: 0 };
...
function initPage() {
	...
	$(".quiz-content").on("QUIZ_RESET_ANSWER", function(){
		$("#animation-01").data("instance").gotoAndStop(null, 0);
		$("#btn-play-ani").show();
		// $("#animation-01").data("instance").stop(null, {onComplete: onComplete, endStop: true, startFrame: 1});
	})
};
