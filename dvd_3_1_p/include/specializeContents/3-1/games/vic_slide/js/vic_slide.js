...
function createObject(index, top, left, eventCallback, parentObjSrc) {
  ...
  chlidWrap.addEventListener('mousedown', eventCallback, false);
  // chlidWrap.addEventListener('touchstart', eventCallback, false);
...
function childCorrMotion(parentObj) {
  ...
  (objNum = objSrc.split("_")), (objNum = objNum.slice(-1));

  correctArray = [
    "images/vic_slide_child_" + objNum + "_success_1.png",
    "images/vic_slide_child_" + objNum + "_success_1.png",
    "images/vic_slide_child_" + objNum + "_success_2.png",
    "images/vic_slide_child_" + objNum + "_success_2.png",
  ];
