...
function createBtn(index, top, left) {
  ...
  btnClickUp = function (e) {
    log("UP!!!");
    e.preventDefault();
    if (!gameManager.isGameover) machinBtn.src = "images/vendingmachine_btn0_0.png";
  ...
  btnWrap.addEventListener('mousedown', btnClickDown, false);
  // btnWrap.addEventListener('touchstart', btnClickDown, false);
  btnWrap.addEventListener('mouseup', btnClickUp, false);
  // btnWrap.addEventListener('touchend', btnClickUp, false);
}
...
function compareAnswer(currentObj) {
  ...
  if (parseInt(currentBtnText.getAttribute("answerValue")) === gameManager.CURRENT_ANSWER[0]) {
    ...
    var spriteArray = [
        "images/vendingmachine_juice_" + currentObjId + "_0.png",
        "images/vendingmachine_juice_" + currentObjId + "_0.png",
        "images/vendingmachine_juice_" + currentObjId + "_1.png",
        "images/vendingmachine_juice_" + currentObjId + "_1.png",
        "images/vendingmachine_juice_" + currentObjId + ".png",
        "images/vendingmachine_juice_" + currentObjId + ".png",
      ],
