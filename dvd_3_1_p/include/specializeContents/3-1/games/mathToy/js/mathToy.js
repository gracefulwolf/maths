function initScene() {
  ...
  appendImageElement(
    "front",
    "images/mathtoy_img_" + randResult[0] + ".png",
    document.querySelector("#math_1")
  );
  appendImageElement(
    "backSeat",
    "images/mathtoy_img_" + randResult[1] + ".png",
    document.querySelector("#math_2")
  );
  appendImageElement(
    "lightring",
    "images/mathtoy_light_off.png",
    document.querySelector("#bgCanvas")
  );
  // }

  appendChoiceQuestion(
    "click",
    gameManager.choiceQuestion,
    gameManager.choiceQuestionImgArray
  );

  var choiceQuestionContainer = document.querySelector(
  ...
  function onStartButtonDown() {
    ...
    setTimeout(function () {
      ...
      math_1.setAttribute(
        "style",
        "position: absolute; left:330px; top:198px; font-family: NanumGothicExtraBold; line-height: 134px; font-size: 80px; text-align: center; width:180px;"
      );
    }, 1000);
    ...
    setTimeout(function () {
      ...
      math_2.setAttribute(
        "style",
        "position: absolute; left:730px; top:198px; font-family: NanumGothicExtraBold; line-height: 134px; font-size: 80px; text-align: center; width:180px;"
      );
    }, 2100);
...
function handMotion() {
  ...
  var spriteArray_0 = [
    "images/mathtoy_img_mov_1.png",
    "images/mathtoy_img_mov_2.png",
    "images/mathtoy_img_mov_3.png",
    "images/mathtoy_img_mov_4.png",
    "images/mathtoy_img_mov_5.png",
    "images/mathtoy_img_mov_1.png",
    "images/mathtoy_img_mov_2.png",
    "images/mathtoy_img_mov_3.png",
    "images/mathtoy_img_mov_4.png",
  ...
  spriteArray_1 = [
    "images/mathtoy_symbol_mov_1.png",
    "images/mathtoy_symbol_mov_2.png",
    "images/mathtoy_symbol_mov_3.png",
    "images/mathtoy_symbol_mov_4.png",
    "images/mathtoy_symbol_mov_1.png",
    "images/mathtoy_symbol_mov_2.png",
    "images/mathtoy_symbol_mov_3.png",
    "images/mathtoy_symbol_mov_4.png",
...
function gameOverLightring() {
  ...
  spriteArray_3 = [
    "images/mathtoy_light_off.png",
    "images/mathtoy_light_on1.png",
    "images/mathtoy_light_on2.png",
    "images/mathtoy_light_on1.png",
    "images/mathtoy_light_on2.png",
    "images/mathtoy_light_on1.png",
    "images/mathtoy_light_on2.png",
...
function gameOver(dragObj) {
  ...
  document
    ...
    .setAttribute(
      "style",
      "position: absolute; display: block; top:" +
        (dragObj.offsetTop + 20) +
        "px; left:" +
        (dragObj.offsetLeft + 70) +
        "px;"
    );
