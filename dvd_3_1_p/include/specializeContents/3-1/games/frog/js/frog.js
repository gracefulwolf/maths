...
function initBead(frogBg) {
  ...
  frogBg.setAttribute("style", "top: 60px; right: 50px;");
...
function appendChoiceQuestion(buttonType, choiceQuestionArray, imgSrcArray) {
  ...
  for (var i = 0; i < choiceQuestionArray.length; i++) {
    ...
    currentQuestion.setAttribute("style", "top: 505px; left:" + choiceLeft + "px;");
    ...
    gameManager.choiceQuestionPosition.push([505, choiceLeft]);
    if (buttonType === "drag") {
...
function frogMotioncorrect() {
  ...
  frogMotion.setAttribute("style", "top: 60px; right: 50px; z-index: 2;");
