function rulerLengthElement() {
  ...
  dropArea.setAttribute("style", "top:106px; left:310px;");
  appendQuiz("drag");
}
...
function appendQuiz(buttonType) {
  ...
  switch (gameManager.QUIZ_OPTION[0]) {
    case "버스":
      ...
      break;
    case "캠핑카":
      imageName = "campingCar";
      lineBarLeft = 267;
      break;
    case "붓":
      imageName = "brush";
      lineBarLeft = -4;
      objectBon.style.left = '64px';
      break;
    case "크레파스":
      imageName = "crayon";
      lineBarLeft = -13;
  ...
  image.src = "images/obj_" + imageName + ".png";
  imageBon.src = "images/objBon_" + imageName + ".png";
