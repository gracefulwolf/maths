...
function rabbitcaveInit() {
  ...
  setRand(1, 5, 5);
  gameManager.peaArray1 = [
    "images/vic_pea_pea_" + randResult[0] + ".png",
    "images/vic_pea_pea_" + randResult[1] + ".png",
    "images/vic_pea_pea_" + randResult[2] + ".png",
    "images/vic_pea_pea_" + randResult[3] + ".png",
  ];
...
function peaClickSound() {
  ...
  for (var i = 0; i < peaContainer.childNodes.length; i++) {
    ...
    peaDown = function (e) {
      e.preventDefault();
      var objId = this.id;
      (objNum = objId.slice(-1)), streamSound.setSound(gameManager.SoundArray[objNum]);
    };
    peaUp = function (e) {
      e.preventDefault();
      peaClickMotion(this);
    };
    peaImgWrap.addEventListener('mousedown', peaDown, false);
    // peaImgWrap.addEventListener('touchstart', peaDown, false);
    peaImgWrap.addEventListener('mouseup', peaUp, false);
    // peaImgWrap.addEventListener('touchend', peaUp, false);
  }
}
