...
function createObject(index, left, parentObjSrc, numContainer, eventCallback, callback) {
  ...
  // parentObj.addEventListener("mouseup", upEventHandler, false);
  // parentObj.addEventListener("touchend", upEventHandler, false);
...
function appendChoiceQuestion(buttonType, choiceQuestionArray, imgSrcArray) {
  ...
  for (var i = 0; i < choiceQuestionArray.length; i++) {
    ...
    if (imgSrcArray) {
      ...
      imgObjText.setAttribute("id", "choiceQuestionText_" + i);
      imgObjText.setAttribute("style", "top: 20px; left: 30px;");
      (imgObjText.innerHTML = gameManager.choiceQuestion[i]), className;
      ...
      // 대분수
      var mixedFractionTextValue = gameManager.choiceQuestion[i][0];
      mixedFractionText.setAttribute("id", "fountainText_" + i);
      mixedFractionText.className = "mixedFraction";
      mixedFractionText.setAttribute("style", "position:absolute;top: 0px; left: " + left + "px;");
      if (!!mixedFractionTextValue) {
        mixedFractionText.innerHTML = mixedFractionTextValue;
      }

      left = 30;
      imgObjText.setAttribute("id", "choiceQuestionText_" + i);
      imgObjText.className = "Text";
      imgObjText.setAttribute("style", "position:absolute; top: -30px; left: " + left + "px; width:60px;");
      ...
      fountainText.setAttribute("style", "position:absolute; top: 30px; left: " + left + "px; width:60px;");
      ...
      fountainLine.setAttribute("style", "position:absolute; top: 2px; left: " + left + "px; letter-spacing:-9px");
      ...
      choiceQuestionAllBox.setAttribute("style", "position:absolute; top:15px; left: " + left + "px; width:120px; height:125px;");
