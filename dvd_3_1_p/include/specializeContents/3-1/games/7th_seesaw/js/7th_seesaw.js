...
var Ball = function () {
  ...
  var setContents = function () {
    ...
    if (typeof _value !== "string") {
      ...
      if (span.querySelector("img")) span.querySelector("img").style.cssText = "width: 30px; height: auto; margin: 0;";
    }
  };
...
var Seesaw = function () {
  ...
  var feedBackClear = function () {
    ...
    for (var i = 0; i < 2; i++) {
      ...
      if (ball.classList[2] === "number") ball.classList.remove(ball.classList[1]);
      else ball.classList.remove(ball.classList[2]);
...
function createSeesaw() {
  ...
  QS("#bgCanvas").innerHTML =
    '<div id="seesawContainer"><div class="seesaw_shadow"></div><div class="seesaw_bon2"></div><div id="seesawHor" class="seesaw_hor"></div><div class="seesaw_bon1"></div></div><div id="ballAreaContainer"></div><div id="ballContainer"></div><div id="hintContainer"><div id="hitBox" class="hint_box"></div><div id="hintTitle" class="hint_title"><span>크기가 같은 분수로 바꿔 보세요.</span></div><div id="hintList"></div><div id="hintClose"class="hint_close_btn"></div></div><div id="btnContainer"><div id="hintBtn"></div></div>';
...
function initScene() {
  ...
  gameManager.randomArray = makeRandomArray(1, 5);
  console.log("gameManager.randomArray:", gameManager.randomArray);
