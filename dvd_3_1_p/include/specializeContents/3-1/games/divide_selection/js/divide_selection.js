function initScene() {
  ...
  switch (randomColor) {
    case 0:
      gameManager.choiceBgImgArray = [
        "images/divide_select_" + figureArray[0] + "_" + answer1 + "_" + randResult[0] + ".png",
        "images/divide_select_" + figureArray[0] + "_" + answer2 + "_" + randResult[0] + ".png",
        "images/divide_select_" + figureArray[0] + "_" + answer3 + "_" + randResult[0] + ".png",
      ];
      break;
    case 1:
      gameManager.choiceBgImgArray = [
        "images/divide_select_" + figureArray[1] + "_" + answer1 + "_" + randResult[0] + ".png",
        "images/divide_select_" + figureArray[1] + "_" + answer2 + "_" + randResult[0] + ".png",
        "images/divide_select_" + figureArray[1] + "_" + answer3 + "_" + randResult[0] + ".png",
      ];
      break;
    case 2:
      gameManager.choiceBgImgArray = [
        "images/divide_select_" + figureArray[2] + "_" + answer1 + "_" + randResult[0] + ".png",
        "images/divide_select_" + figureArray[2] + "_" + answer2 + "_" + randResult[0] + ".png",
        "images/divide_select_" + figureArray[2] + "_" + answer3 + "_" + randResult[0] + ".png",
      ];
      break;
    case 3:
      gameManager.choiceBgImgArray = [
        "images/divide_select_" + figureArray[3] + "_" + answer1 + "_" + randResult[0] + ".png",
        "images/divide_select_" + figureArray[3] + "_" + answer2 + "_" + randResult[0] + ".png",
        "images/divide_select_" + figureArray[3] + "_" + answer3 + "_" + randResult[0] + ".png",
      ];
      break;
  }
