...
function queTxt() {
  ...
  var cal_1;
  if (gameManager.TOTAL_ANSWER_ARRAY.length === 4) {
    ...
    cal_1 = gameManager.TOTAL_ANSWER_ARRAY[3];
  } else if (gameManager.TOTAL_ANSWER_ARRAY.length === 3) {
    queText1.innerHTML = "&nbsp;";
    queText2.innerHTML = gameManager.TOTAL_ANSWER_ARRAY[0];
    queText3.innerHTML = gameManager.TOTAL_ANSWER_ARRAY[1];
    cal_1 = gameManager.TOTAL_ANSWER_ARRAY[2];
  }
...
function writeNumber(keyObj) {
  ...
  switch (keyNum) {
    case 10:
      ...
      break;
    case 11:
      if (answer.innerHTML.length == 5) return;
