...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/scrap/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _global_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../global/core */ \"./src/js/global/core.js\");\n/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../localStorage */ \"./src/js/localStorage/index.js\");\n/* harmony import */ var _localStorage_folder__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../localStorage/folder */ \"./src/js/localStorage/folder.js\");\n/* harmony import */ var _localStorage_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../localStorage/data */ \"./src/js/localStorage/data.js\");\n/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../util */ \"./src/js/util/index.js\");\n/* harmony import */ var _util_modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../util/modal */ \"./src/js/util/modal.js\");\n/* harmony import */ var _scss_scrap_index_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../scss/scrap/index.scss */ \"./src/scss/scrap/index.scss\");\n/* harmony import */ var _scss_scrap_index_scss__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_scss_scrap_index_scss__WEBPACK_IMPORTED_MODULE_6__);\n\n\n\n\n\n\n\nconsole.log('> myClassMaker scrap entry point'); // INITIATE\n\nObject(_localStorage__WEBPACK_IMPORTED_MODULE_1__[\"initiateMyClassMaker\"])();\nwindow.MY_CLASS_MAKER = window.MY_CLASS_MAKER || {};\nwindow.MY_CLASS_MAKER.scrapper = {\n  modal: function modal(message, confirmCallback) {\n    Object(_util_modal__WEBPACK_IMPORTED_MODULE_5__[\"default\"])({\n      message: message,\n      confirmCallback: confirmCallback\n    });\n  },\n  scrapArchive: function scrapArchive(opts) {\n    var _this = this;\n\n    var name = opts.name,\n        url = opts.url,\n        fileType = opts.fileType,\n        successCallback = opts.successCallback,\n        failureCallback = opts.failureCallback;\n    Object(_localStorage_folder__WEBPACK_IMPORTED_MODULE_2__[\"READ_DEFAULT_FOLDER\"])(function (defaultFolder) {\n      Object(_localStorage_data__WEBPACK_IMPORTED_MODULE_3__[\"READ_DATAS\"])(defaultFolder.folderId, function (datas) {\n        var archiveDatas = datas.filter(function (data) {\n          return data.type === 'archive';\n        });\n\n        if (archiveDatas.some(function (data) {\n          return data.url === url;\n        })) {\n          _this.modal('이미 스크랩되었습니다.\\n(모달 팝업 만들어야 함.)', function () {\n            if (failureCallback) {\n              failureCallback();\n            }\n          });\n        } else {\n          Object(_localStorage_data__WEBPACK_IMPORTED_MODULE_3__[\"CREATE_DATA\"])({\n            name: name,\n            type: 'archive',\n            url: url,\n            fileType: fileType || Object(_util__WEBPACK_IMPORTED_MODULE_4__[\"getFileType\"])(url) // lesson,\n            // page,\n\n          }, function () {\n            _this.modal('스크랩 성공.\\n(모달 팝업 만들어야 함.)', function () {\n              if (successCallback) {\n                successCallback();\n              }\n            });\n          });\n        }\n      });\n    });\n  },\n  scrapContent: function scrapContent(opts) {\n    var _this2 = this;\n\n    var url = opts.url,\n        thumbnail = opts.thumbnail,\n        subject = opts.subject,\n        lesson = opts.lesson,\n        page = opts.page,\n        successCallback = opts.successCallback,\n        failureCallback = opts.failureCallback;\n    Object(_localStorage_folder__WEBPACK_IMPORTED_MODULE_2__[\"READ_DEFAULT_FOLDER\"])(function (defaultFolder) {\n      Object(_localStorage_data__WEBPACK_IMPORTED_MODULE_3__[\"READ_DATAS\"])(defaultFolder.folderId, function (datas) {\n        var contentDatas = datas.filter(function (data) {\n          return data.type === 'content';\n        });\n\n        if (contentDatas.some(function (data) {\n          return data.url === url;\n        })) {\n          _this2.modal('이미 스크랩되었습니다.');\n\n          if (failureCallback) {\n            failureCallback();\n          }\n        } else {\n          Object(_localStorage_data__WEBPACK_IMPORTED_MODULE_3__[\"CREATE_DATA\"])({\n            name: \"\".concat(subject, \" \").concat(lesson, \" \").concat(page, \"\\uCABD \\uCF58\\uD150\\uCE20\"),\n            type: 'content',\n            url: url,\n            thumbnail: thumbnail,\n            lesson: lesson // page,\n\n          }, function () {\n            _this2.modal('스크랩 성공.');\n\n            if (successCallback) {\n              successCallback();\n            }\n          });\n        }\n      });\n    });\n  }\n};\n\n//# sourceURL=webpack:///./src/js/scrap/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return modal; });\n/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! . */ \"./src/js/util/index.js\");\n/* harmony import */ var _responsive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./responsive */ \"./src/js/util/responsive.js\");\n\n\nfunction modal(opts) {\n  var CLASS_BASIC = 'mcm-modal'; // const imagePath = opts.imagePath || window.location.href.split('/resource')[0]\n  //   .concat('/resource/include/myClassMaker/src/static/image/modal/');\n\n  var parent = opts.parent || document.body;\n  var message = opts.message || '모달 팝업 메시지를 입력하세요.';\n  var isCancelVisible = opts.isCancelVisible || false;\n  var confirmCallback = opts.confirmCallback || undefined;\n  var cancelCallback = opts.cancelCallback || undefined;\n  var containerClassNames = [CLASS_BASIC];\n  isCancelVisible && containerClassNames.push(\"\".concat(CLASS_BASIC, \"--confirm\"));\n  var container = Object(___WEBPACK_IMPORTED_MODULE_0__[\"CE\"])({\n    parent: parent,\n    classNames: containerClassNames\n  });\n\n  var _responsive = Object(_responsive__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(Object(___WEBPACK_IMPORTED_MODULE_0__[\"CE\"])({\n    parent: container,\n    classNames: [\"\".concat(CLASS_BASIC, \"__responsive\")]\n  }));\n\n  var responsiveContainer = _responsive.target;\n\n  function close() {\n    parent.removeChild(container);\n  }\n\n  function onButtonClick(__event) {\n    var isConfirm = /confirm/g.test(__event.target.className);\n    close();\n\n    if (isConfirm) {\n      if (confirmCallback) {\n        confirmCallback();\n      }\n    } else if (cancelCallback) {\n      cancelCallback();\n    }\n  }\n\n  _responsive.resize(function () {\n    var inner = Object(___WEBPACK_IMPORTED_MODULE_0__[\"CE\"])({\n      parent: responsiveContainer,\n      classNames: [\"\".concat(CLASS_BASIC, \"__inner\")]\n    });\n    Object(___WEBPACK_IMPORTED_MODULE_0__[\"CE\"])({\n      parent: inner,\n      classNames: [\"\".concat(CLASS_BASIC, \"__layer\"), \"\".concat(CLASS_BASIC, \"__layer--message\")],\n      text: message\n    });\n    var buttonLayer = Object(___WEBPACK_IMPORTED_MODULE_0__[\"CE\"])({\n      parent: inner,\n      classNames: [\"\".concat(CLASS_BASIC, \"__layer\"), \"\".concat(CLASS_BASIC, \"__layer--button\")]\n    });\n\n    if (isCancelVisible) {\n      Object(___WEBPACK_IMPORTED_MODULE_0__[\"CE\"])({\n        tag: 'button',\n        parent: buttonLayer,\n        classNames: [\"\".concat(CLASS_BASIC, \"__button\"), 'cancel'],\n        text: '취소'\n      }).onclick = onButtonClick;\n    }\n\n    Object(___WEBPACK_IMPORTED_MODULE_0__[\"CE\"])({\n      tag: 'button',\n      parent: buttonLayer,\n      classNames: [\"\".concat(CLASS_BASIC, \"__button\"), 'confirm'],\n      text: '확인'\n    }).onclick = onButtonClick;\n    buttonLayer.children[0].focus();\n  });\n\n  return container;\n}\n\n//# sourceURL=webpack:///./src/js/util/modal.js?");
...
eval("var api = __webpack_require__(/*! ../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ \"./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js\");\n            var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js??ref--4-1!../../../node_modules/sass-loader/dist/cjs.js??ref--4-2!./index.scss */ \"./node_modules/css-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./src/scss/scrap/index.scss\");\n\n            content = content.__esModule ? content.default : content;\n\n            if (typeof content === 'string') {\n              content = [[module.i, content, '']];\n            }\n\nvar options = {};\n\noptions.insert = \"head\";\noptions.singleton = false;\n\nvar update = api(content, options);\n\n\n\nmodule.exports = content.locals || {};\n\n//# sourceURL=webpack:///./src/scss/scrap/index.scss?");
