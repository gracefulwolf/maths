...
window.MATH.archive['math_3-1'] = {
  ...
  datas: {
    // common: [
    //   [
    //     { disabled: false, fileUrl: '../../data/공통 자료/3-1 전단원 PDF자료-수학 익힘.pdf', disabledLessons: [7] },
    //     { disabled: false, fileUrl: '../../data/공통 자료/3-1 전단원 PDF자료-수학.pdf' },
    //     { disabled: false, fileUrl: '../../data/공통 자료/3-1 전단원 PDF자료-지도서 총론.pdf', disabledLessons: [7] },
    //     { disabled: false, fileUrl: '../../data/공통 자료/3-1 전단원 PDF자료-지도서.pdf' },
    //   ],
    ...
    lessons: [
      ...
      [
        ...
        // 4차시
        [
          { fileUrl: '../../data/01/1단원_4, 5차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/01/PDF 자료-수학/1단원_4, 5차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/01/PDF 자료-지도서/1단원_4, 5차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/01/PDF 자료-수학 익힘/1단원_4, 5차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/01/1단원_4, 5차시 형성평가.hwp', disabled: false },
        ],
        // 5차시
        [
        ...
        // 7차시
        [
          { fileUrl: '../../data/01/1단원_8차시 수업용 PPT.pptx', disabled: false },
          [
            ...
            { fileUrl: '../../data/01/PDF 자료-수학 익힘/1단원_8차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/01/1단원_8차시 형성평가.hwp', disabled: false },
        ],
        // 8차시
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/01/PDF 자료-수학/1단원_9차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/01/PDF 자료-지도서/1단원_9차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '', disabled: true },
          ],
          { fileUrl: '', disabled: true },
        ],
        ...
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/01/PDF 자료-수학/1단원_10, 11차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/01/PDF 자료-지도서/1단원_10, 11차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/01/PDF 자료-수학 익힘/1단원_10, 11차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '', disabled: true },
        ],
        // 10차시
        ...
        [
          [
            ...
            { disabled: false, fileUrl: '../../data/공통 자료/3-1 전단원 PDF 자료-지도서 총론.pdf' },
          ],
      ...
      [
        ...
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/02/PDF 자료-수학/2단원_9, 10차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/02/PDF 자료-지도서/2단원_9, 10차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/02/PDF 자료-수학 익힘/2단원_9, 10차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '', disabled: true },
        ],
        // 10차시
      ...
      [
        ...
        [
          ...
          [
            ...
            { fileUrl: '../../data/03/3단원 준비물_준비물.hwp', disabled: false },
          ],
        ],
        // 1차시
        [
        ...
        // 2차시
        [
          { fileUrl: '../../data/03/3단원_2, 3차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/03/PDF 자료-수학/3단원_2, 3차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/03/PDF 자료-지도서/3단원_2, 3차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/03/PDF 자료-수학 익힘/3단원_2, 3차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/03/3단원_2, 3차시 형성평가.hwp', disabled: false },
        ],
        // 3차시
        [
          { fileUrl: '../../data/03/3단원_4, 5차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/03/PDF 자료-수학/3단원_4, 5차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/03/PDF 자료-지도서/3단원_4, 5차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/03/PDF 자료-수학 익힘/3단원_4, 5차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/03/3단원_4, 5차시 형성평가.hwp', disabled: false },
        ],
        // 4차시
        [
      ...
      [
        ...
        [
          ...
          [
            ...
            { fileUrl: '../../data/04/4단원 준비물_준비물.hwp', disabled: true },
          ],
        ],
        // 1차시
        [
        ...
        // 2차시
        [
          { fileUrl: '../../data/04/4단원_2차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/04/PDF 자료-수학/4단원_2차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-지도서/4단원_2차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-수학 익힘/4단원_2차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/04/4단원_2차시 형성평가.hwp', disabled: false },
        ],
        // 3차시
        [
          { fileUrl: '../../data/04/4단원_3차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/04/PDF 자료-수학/4단원_3차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-지도서/4단원_3차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-수학 익힘/4단원_3차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/04/4단원_3차시 형성평가.hwp', disabled: false },
        ],
        // 4차시
        [
          { fileUrl: '../../data/04/4단원_4차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/04/PDF 자료-수학/4단원_4차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-지도서/4단원_4차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-수학 익힘/4단원_4차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/04/4단원_4차시 형성평가.hwp', disabled: false },
        ],
        // 5차시
        [
          { fileUrl: '../../data/04/4단원_5차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/04/PDF 자료-수학/4단원_5차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-지도서/4단원_5차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-수학 익힘/4단원_5차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/04/4단원_5차시 형성평가.hwp', disabled: false },
        ],
        // 6차시
        [
          { fileUrl: '../../data/04/4단원_6차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/04/PDF 자료-수학/4단원_6차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-지도서/4단원_6차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-수학 익힘/4단원_6차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/04/4단원_6차시 형성평가.hwp', disabled: false },
        ],
        // 7차시
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/04/PDF 자료-수학/4단원_7차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-지도서/4단원_7차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '', disabled: true },
          ],
          { fileUrl: '', disabled: true },
        ],
        ...
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/04/PDF 자료-수학/4단원_8, 9차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-지도서/4단원_8, 9차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/04/PDF 자료-수학 익힘/4단원_8, 9차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '', disabled: true },
        ],
        // 9차시
      ...
      [
        ...
        // 4차시
        [
          { fileUrl: '../../data/05/5단원_4, 5차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/05/PDF 자료-수학/5단원_4, 5차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-지도서/5단원_4, 5차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-수학 익힘/5단원_4, 5차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/05/5단원_4, 5차시 형성평가.hwp', disabled: false },
        ],
        // 5차시
        [
          { fileUrl: '../../data/05/5단원_6차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/05/PDF 자료-수학/5단원_6차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-지도서/5단원_6차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-수학 익힘/5단원_6차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/05/5단원_6차시 형성평가.hwp', disabled: false },
        ],
        // 6차시
        [
          { fileUrl: '../../data/05/5단원_7차시 수업용 PPT.pptx', disabled: false },
          [
            ...
            { fileUrl: '../../data/05/PDF 자료-수학 익힘/5단원_7차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/05/5단원_7차시 형성평가.hwp', disabled: false },
        ],
        // 7차시
        [
          { fileUrl: '../../data/05/5단원_8차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/05/PDF 자료-수학/5단원_8차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-지도서/5단원_8차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-수학 익힘/5단원_8차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/05/5단원_8차시 형성평가.hwp', disabled: false },
        ],
        // 8차시
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/05/PDF 자료-수학/5단원_9차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-지도서/5단원_9차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '', disabled: true },
          ],
          { fileUrl: '', disabled: true },
        ],
        ...
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/05/PDF 자료-수학/5단원_10, 11차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-지도서/5단원_10, 11차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/05/PDF 자료-수학 익힘/5단원_10, 11차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '', disabled: true },
        ],
        // 10차시
      ...
      [
        ...
        // 8차시
        [
          { fileUrl: '../../data/06/6단원_8차시 수업용 PPT.pptx', disabled: false },
          [
            ...
            { fileUrl: '../../data/06/PDF 자료-수학 익힘/6단원_8차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/06/6단원_8차시 형성평가.hwp', disabled: false },
        ],
        // 9차시
        [
          { fileUrl: '../../data/06/6단원_9차시 수업용 PPT.pptx', disabled: false },
          [
            { fileUrl: '../../data/06/PDF 자료-수학/6단원_9차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/06/PDF 자료-지도서/6단원_9차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/06/PDF 자료-수학 익힘/6단원_9차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '../../data/06/6단원_9차시 형성평가.hwp', disabled: false },
        ],
        // 10차시
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/06/PDF 자료-수학/6단원_10차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/06/PDF 자료-지도서/6단원_10차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '', disabled: true },
          ],
          { fileUrl: '', disabled: true },
        ],
        ...
        [
          { fileUrl: '', disabled: true },
          [
            { fileUrl: '../../data/06/PDF 자료-수학/6단원_11, 12차시 PDF 자료(수학).pdf', disabled: false },
            { fileUrl: '../../data/06/PDF 자료-지도서/6단원_11, 12차시 PDF 자료(지도서).pdf', disabled: false },
            { fileUrl: '../../data/06/PDF 자료-수학 익힘/6단원_11, 12차시 PDF 자료(수학 익힘).pdf', disabled: false },
          ],
          { fileUrl: '', disabled: true },
        ],
        // 12차시
